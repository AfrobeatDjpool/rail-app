...
throw new Error("Module build failed: SyntaxError: Adjacent JSX elements must be wrapped in an enclosing tag (32:6)\n\n  30 |         </div>\n  31 |         \n> 32 |       <ul>\n     |       ^\n  33 |         {cars.map(function(name, index){\n  34 |             return <li key={ index }>{name.brand}</li>;\n  35 |           })}\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-59eaa7d740755528f92c.js.map